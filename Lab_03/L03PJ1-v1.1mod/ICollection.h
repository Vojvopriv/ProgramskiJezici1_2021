...
public:
	...
	virtual bool operator==(const ICollection& other) const final {
		return this->compareSets(other);
	}
	...
	//virtual void printObjects() const = 0;
	...
	//virtual ICollection* transformElements(std::function<void(const IObject&)>&) const = 0;
